...
for nqueens in {31..50}; do
    echo $nqueens
   python3 main_benchmark.py -m "queens" -s "saves/scores_queens.csv" -p $nqueens -var 2 -val 1 > "logs/logs_queens/${nqueens}_${var_heuristic}.txt" 
done
